...
var secCookie *securecookie.SecureCookie = securecookie.New([]byte("DfffweWERR4FfgDSFSghhhrrSq"), []byte{0x5d, 0xa5, 0xd3, 0x90, 0xc9, 0x54, 0xa1, 0xc3, 0x70, 0x00, 0x8d, 0x6d, 0xa9, 0xd1, 0x07, 0x53})
